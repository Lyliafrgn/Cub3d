...
#    Updated: 2025/10/08 09:28:23 by ofilloux         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MINIMAP =	src/exec/minimap/minimap.c \
			...
			src/exec/minimap/cross_wall_utils.c
...
test	:	$(NAME)
			valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --track-fds=yes ./cub3D ./maps/test2.cub
